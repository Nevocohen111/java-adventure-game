...
public class Locations implements Map<Integer,Location> {
    ...
    static {
        ...
        locations.put(0, new Location(0, "You have reached the final destination", tempExit));
        ...
        tempExit = new HashMap<>();
        tempExit.put("W", 1);
        locations.put(3, new Location(3, "You are inside a building, a well house for a small stream", tempExit));
        tempExit = new HashMap<>();
        tempExit.put("N", 1);
        tempExit.put("W", 2);
